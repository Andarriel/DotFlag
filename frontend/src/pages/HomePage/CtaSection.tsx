    ...
    <div className="relative isolate overflow-hidden bg-slate-950 px-4 sm:px-6 py-20 sm:py-28">
      ...
      <div className="mx-auto max-w-7xl text-center relative z-10">
        ...
        <p className="mx-auto mt-4 max-w-md text-sm text-slate-500">
          {isAuthenticated ? 'Ready for the next challenge?' : 'Create an account and start capturing flags.'}
        </p>
        <div className="mt-8">
          <Link
            to={isAuthenticated ? ROUTES.CHALLENGES : ROUTES.REGISTER}
          ...
          >
            <span className="relative z-10 flex items-center gap-2">
              {isAuthenticated ? 'View Challenges' : 'Get Started'}
