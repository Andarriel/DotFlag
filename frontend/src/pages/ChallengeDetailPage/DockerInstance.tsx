...
import { Play, Square, Terminal, Clock, Wifi, Copy, Check, Loader2, RefreshCw } from 'lucide-react';
...
export default function DockerInstance({ challengeId }: { challengeId: number }) {
  ...
  const restartInstance = async () => {
    ...
    try {
      ...
      toast.error(err?.response?.data?.message ?? 'Failed to restart instance');
    } finally {
          ...
          <>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                disabled={actionLoading || restartLoading}
